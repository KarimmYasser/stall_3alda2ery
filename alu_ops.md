...
LDM => 1001(01) -> send R[rs1] with 0 and select immediate and add them because we dont have pass operand 2
LDD => 1001(01) -> select imm and add to R[rs1]
STD => 1001(01) -> select imm and add to R[rs1] -> the difference is in the control signals
